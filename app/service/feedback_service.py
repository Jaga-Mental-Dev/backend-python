...
class EmotionFeedbackAgent:
    def __init__(self):
        ...
        self.emotion_templates = {
            ...
            Berikan respons yang singkat, maksimal 3 kalimat, pernyataan bukan pertanyaan, natural dan tulus, seolah-olah berbicara dengan teman dekat. Tunjukkan bahwa kamu ikut merasakan kebahagiaannya dan dorong dengan lembut untuk terus bersyukur dan berbagi kebahagiaan ini.
            ...
            Berikan respons yang singkat, maksimal 3 kalimat, pernyataan bukan pertanyaan, penuh empati dan kepedulian, seolah-olah berbicara dengan sahabat dekat yang sedang bersedih. Tunjukkan bahwa kamu benar-benar mendengarkan dan memahami perasaannya. Tawarkan dukungan emosional dengan lembut.
            ...
            Berikan respons yang singkat, maksimal 3 kalimat, pernyataan bukan pertanyaan, penuh kehangatan dan sukacita, seolah-olah berbicara dengan teman dekat yang sedang jatuh cinta atau merasakan kasih sayang yang mendalam. Tunjukkan bahwa kamu ikut merasakan keindahan perasaan ini.
            ...
            Berikan respons yang singkat, maksimal 3 kalimat, pernyataan bukan pertanyaan, penuh pengertian dan reflektif, seolah-olah berbicara dengan teman yang sedang dalam mood biasa saja. Tunjukkan bahwa kamu menghargai kejujurannya dan bantu dia melihat nilai dari momen tenang ini.
            ...
            Berikan respons yang singkat, maksimal 3 kalimat, pernyataan bukan pertanyaan, menenangkan namun tidak menghakimi, seolah-olah berbicara dengan teman dekat yang sedang marah. Tunjukkan bahwa kamu memahami mengapa dia merasa seperti itu dan validasi perasaannya dengan cara yang mendukung.
